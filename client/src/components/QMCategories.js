...
const QMCategories = () => {
  ...
  return (
    <Container className="top-anxiety">
      ...
      <Row>
        <Col>
          <ItemListHeader>Категории</ItemListHeader>
        </Col>
        <Col xs={middleWidth}>
          <ItemListHeader style={{ textAlign: 'center' }}>Раунд {roundNo + 1}</ItemListHeader>
        </Col>
        <Col>
          <ItemListHeader>Выбранные категории</ItemListHeader>
        </Col>
      </Row>
